...
--> statement-breakpoint
CREATE TABLE "user_lesson_completes" (
	"userId" uuid NOT NULL,
	"lessonId" uuid NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "user_lesson_completes_userId_lessonId_pk" PRIMARY KEY("userId","lessonId")
);
--> statement-breakpoint
...
ALTER TABLE "user_lesson_completes" ADD CONSTRAINT "user_lesson_completes_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_lesson_completes" ADD CONSTRAINT "user_lesson_completes_lessonId_lessons_id_fk" FOREIGN KEY ("lessonId") REFERENCES "public"."lessons"("id") ON DELETE cascade ON UPDATE no action;